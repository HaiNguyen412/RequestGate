...
function DropDownDepartment({ arrayList, className, title, setDataItem, name}) {
      ...
      >
        ...
        <div
          className={`${open ? "visible" : "invisible"
            } absolute z-30 overflow-auto h-44 bg-white top-full outline-1 outline outline-slate-900 w-full`}
        >
